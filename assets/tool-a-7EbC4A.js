...
import { TrendLineTool } from "./tool-m4dmOxDg.js";
import { U as ExtendedLineToolType } from "./index-DNbtFiKr.js";
...
import "./TrendToolWithStatsPaneView-B0NglOSE.js";
...
import "./PlusTextRendererDecorator-C8ewAP0n.js";
import "./line-CuaAD_DW.js";
import "./renderer-Bgvp02WJ.js";
class ExtendedLineTool extends TrendLineTool {
  constructor() {
    super(...arguments);
    __publicField(this, "type", ExtendedLineToolType);
    __publicField(this, "extendLeft", true);
    __publicField(this, "extendRight", true);
  }
}
export {
  ExtendedLineTool
