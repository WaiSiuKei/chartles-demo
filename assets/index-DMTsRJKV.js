...
let DrawingRegistryContrib = class extends Disposable {
  constructor(toolRegistry) {
    ...
    this.registerTool({
      ...
      Ctor: () => __vitePreload(() => import("./tool-CqjVfwWk.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0, import.meta.url).then((module) => module.PasteImageTool)
    });
