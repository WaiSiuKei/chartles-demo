...
import { P as PitchforkPrimitive, a as PitchforkStyle } from "./primitive-C-c5Kqmf.js";
import { a7 as ModifiedSchiffPitchforkToolType } from "./index-TSHQCVD9.js";
...
class ModifiedSchiffPitchforkTool extends DrawingTool {
  constructor() {
    super(...arguments);
    __publicField(this, "type", ModifiedSchiffPitchforkToolType);
  }
  createPrimitive() {
    return new PitchforkPrimitive(
      {
        ...
        fillBackground: true,
        transparency: 80,
        style: PitchforkStyle.SchiffModified,
        median: {
          visible: true,
          color: "#F23645",
          linewidth: 2,
